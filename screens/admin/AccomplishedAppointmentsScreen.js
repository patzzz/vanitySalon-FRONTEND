...
export default class AccomplishedAppointmentsScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      appointments: [],
  ...
  selectDate = async (desiredDate) => {
    ...
    await fetch(
      "http://185.247.118.91:8082/appointmentPlatform/api/appointment/getCompletedAppointmentsOnDate?date=" +
  ...
  onPageFocus = async () => {
    ...
    await fetch(
      "http://185.247.118.91:8082/appointmentPlatform/api/appointment/getAllCompletedAppointments?page=0&size=20",
      requestOptions
    )
      .then((response) => response.json())
      .then((result) => {
      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.headerText}>
            <Text style={styles.headerTextStyle}>PROGRAMARI EFECTUATE</Text>
          </View>
